...
public class Simulator {
	 ...
	 */
	static String usersFileName = System.getProperty("users.file", "users-QA.txt");
	...
	protected void menu() throws IOException {
		debug.write("QA simulator started");
	...
	protected void start() throws IOException {
		if (smscListener == null) {
			...
			deliveryInfoSender = new DeliveryInfoSender();
                        // CGF 20230417. Comento esto y lo cambio para que se cree despues del listener y despues del BIND
			...
			smscListener.start();
                        // Despues del Listener y entendiendo que llega el BIND, abro el DLR sender
			deliveryInfoSender.start();                        
