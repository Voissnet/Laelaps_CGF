...
public class HablaIpSmppClient extends SMPPClient {
	private static final int CODE_RUTA = Integer.parseInt(System.getProperty("route", "38"));

	public HablaIpSmppClient(int codeRuta, String idoidd) throws Exception {
		super(codeRuta, idoidd);
	}

	public static void main(String args[]) throws Exception {
		new HablaIpSmppClient(CODE_RUTA, "310389").call();
	}
