...
public class DIDwwSmppClient extends SMPPClient {
	private static final int CODE_RUTA = Integer.parseInt(System.getProperty("route", "39"));//defaults to Movistar's route

	public DIDwwSmppClient(int codeRuta, String idoidd) throws Exception {
		super(codeRuta, idoidd);
	}

	public static void main(String args[]) throws Exception {
		new DIDwwSmppClient(CODE_RUTA, "").call();
	}
