...
public class WOMSmppClient extends SMPPClient {
	private static final int CODE_RUTA = Integer.parseInt(System.getProperty("route", "26"));//defaults to Movistar's route

	public WOMSmppClient(int codeRuta, String idoidd) throws Exception {
		super(codeRuta, idoidd);
	}

	public static void main(String args[]) throws Exception {
		new WOMSmppClient(CODE_RUTA, "310225").call();
	}
