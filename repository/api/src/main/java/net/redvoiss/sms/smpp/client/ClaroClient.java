...
public class ClaroClient implements Closeable {
	/**
	 * Revoiss instance variables
	 */
	private DataSource m_ds;
	private static final Logger LOGGER = java.util.logging.Logger.getLogger(ClaroClient.class.getName());
	...
	private static final String QUERY = DAO.loadProperties().getProperty("net.redvoiss.sms.dao.check.sms_sin_nc"); // leo ta,bien esm_class y udh_jeader
	 ...
	 */
	public ClaroClient() throws IOException, SQLException {
	...
	public static void main(String args[]) throws Exception {
		...
		try (final ClaroClient test = new ClaroClient()) {
			test.bind();
			if (test.bound) {
