...
public class SumaclClient implements Closeable {
	/**
	...
	private static final String IDOIDD = System.getProperty("idoidd", "310253");
	 ...
	 * @see FileDebug
	 */
	static Debug debug = new FileDebug(dbgDir, "sumacl.dbg");
	 ...
	 * @see FileEvent
	 */
	static Event event = new FileEvent(dbgDir, "sumacl.evt");

	/**
	 * File with default settings for the application.
	 */
	static String propsFilePath = System.getProperty("smpp.default.cfg", "./sumaclsmpp.cfg");
	 ...
	 */
	public SumaclClient() throws IOException, SQLException {
	...
	public static void main(String args[]) throws Exception {
		...
		try (final SumaclClient test = new SumaclClient()) {
			test.bind();
			if (test.bound) {
