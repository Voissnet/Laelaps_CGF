...
public class WOMClient implements Closeable {
	/**
	 * Revoiss instance variables
	 */
	private DataSource m_ds;
	private static final Logger LOGGER = java.util.logging.Logger.getLogger(WOMClient.class.getName());
	...
	private static final int CODE_RUTA = Integer.parseInt(System.getProperty("route", "26"));// defaults to WOM's route
	private static final String IDOIDD = System.getProperty("idoidd", "310225");
	 ...
	 * @see FileDebug
	 */
	static Debug debug = new FileDebug(dbgDir, "wom.dbg");
	 ...
	 * @see FileEvent
	 */
	static Event event = new FileEvent(dbgDir, "wom.evt");
	 ...
	 * Address of the SMSC.
	 */
	String ipAddress = "201.19.232.69";
	 ...
	 */
	String systemId = "rdvss2wom";

	/**
	 * The password for authentication to SMSC.
	 */
	String password = "rdvss2wom";
	 ...
	 */
	public WOMClient() throws IOException, SQLException {
	...
	public static void main(String args[]) throws Exception {
		...
		try (final WOMClient test = new WOMClient()) {
			test.bind();
			if (test.bound) {
