...
public class TuMundoClient implements Closeable {
	/**
	 * Revoiss instance variables
	 */
	private DataSource m_ds;
	private static final Logger LOGGER = java.util.logging.Logger.getLogger(TuMundoClient.class.getName());
	...
	private static final String IDOIDD = ""; //System.getProperty("idoidd", "310250");
	 ...
	 * @see FileDebug
	 */
	static Debug debug = new FileDebug(dbgDir, "tumundo.dbg");
	 ...
	 * @see FileEvent
	 */
	static Event event = new FileEvent(dbgDir, "tumundo.evt");

	/**
	 * File with default settings for the application.
	 */
	static String propsFilePath = System.getProperty("smpp.default.cfg", "./tumundosmpp.cfg");
	 ...
	 */
	public TuMundoClient() throws IOException, SQLException {
	...
	public static void main(String args[]) throws Exception {
		...
		try (final TuMundoClient test = new TuMundoClient()) {
			test.bind();
			if (test.bound) {
